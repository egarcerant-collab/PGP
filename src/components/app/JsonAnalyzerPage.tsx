...
export default function JsonAnalyzerPage({ setExecutionData, setJsonPrestadorCode, setUniqueUserCount, setRegimenTotals, userRole, userName }: JsonAnalyzerPageProps) {
